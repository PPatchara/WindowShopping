...
(function() {
    function j(c, p) {
        ...
        case "object":
            ...
            if (r && "object" == typeof r) {
                x = r.length;
                for (q = 0; q < x; q += 1)
                    "string" == typeof r[q] && (t = r[q], n = j(t, l), n && e.push(g(t) + (k ? ": " : ":") + n))
                } else 
                    for (t in l)
                        Object.prototype.hasOwnProperty.call(l, t) && (n = j(t, l), n && e.push(g(t) + (k ? ": " : ":") + n));
            n = 0 === e.length ? "{}" : k ? "{\n" + k + e.join(",\n" + k) + "\n" + i + "}" : "{" + e.join(",") + "}";
            k = i;
            return n
        }
    ...
    "function" != typeof JSON.stringify && (JSON.stringify = function(c, g, p) {
        ...
        if ("number" == typeof p)
            ...
            "string" == typeof p && (v = p);
        r = g;
        if (!g || "function" == typeof g || "object" == typeof g && "number" == typeof g.length)
            return j("", {
                "": c
            });
    ...
    "function" !=
    typeof JSON.parse && (JSON.parse = function(c, g) {
        function j(c, k) {
            var i, e, l = c[k];
            if (l && "object" == typeof l)
                for (i in l)
                    Object.prototype.hasOwnProperty.call(l, i) && (e = j(l, i), void 0 !== e ? l[i] = e : delete l[i]);
            return g.call(c, k, l)
        }
        var k, c = String(c);
        p.lastIndex = 0;
        ...
        "]").replace(/(?:^|:|,)(?:\s*\[)+/g, "")))
            return k = eval("(" + c + ")"), "function" == typeof g ? j({
                "": k
            }, "") : k;
...
SockJS = function() {
    ...
    k.prototype.nuke = function() {
        ...
        for (var a = 0; a < this.events.length; a++)
            delete this[this.events[a]]
    };
    c.random_string = function(a, b) {
        var b = b || 37, c, d = [];
        for (c = 0; c < a; c++)
            d.push("abcdefghijklmnopqrstuvwxyz0123456789_".substr(Math.floor(Math.random() *
            b), 1));
        return d.join("")
    };
    ...
    c.amendUrl = function(a) {
        var b = j.location;
        if (!a)
            throw Error("Wrong url for SockJS");
        if (!c.flatUrl(a))
            throw Error("Only basic urls are supported in SockJS");
    ...
    i.prototype._start = function(a, b, f, d) {
        ...
        if (!d ||!d.no_credentials)
            h.xhr.withCredentials = "true";
        if (d && d.headers)
            for (var i in d.headers)
                h.xhr.setRequestHeader(i, d.headers[i]);
    ...
    e.prototype._dispatchMessage = function(a) {
        this.readyState === e.OPEN && this.dispatchEvent(new n("message", {
            data: a
        }))
    };
    ...
    e.prototype._didClose = function(a, b, f) {
        ...
        d.readyState !== e.OPEN && d.readyState !== e.CLOSING)
    ...
    e.prototype._didMessage = function(a) {
        ...
        case "o":
            ...
            break;
        case "a":
            for (var a = JSON.parse(a.slice(1) || "[]"), b = 0; b < a.length; b++)
                this._dispatchMessage(a[b]);
            break;
        case "m":
    ...
    e.prototype._try_next_protocol = function(a) {
        ...
        b._transport_tref = null); ;) {
            ...
            if (!a)
                return !1;
            if (e[a]&&!0 === e[a].need_body && (!j.body || "undefined" != typeof j.readyState && "complete" !== j.readyState))
                return b._protocols.unshift(a), b.protocol = "waiting-for-load", c.attachEvent("load", function() {
    ...
    i.prototype._schedule_recv = function() {
        ...
        if ("undefined" == typeof m.async && j.attachEvent)
            if (/opera/i.test(navigator.userAgent))
                i = j.createElement("script"), i.text = "try{var a = document.getElementById('" + m.id + "'); if(a)a.onerror();}catch(x){};", m.async = i.async=!1;
            else {
                try {
    ...
    function() {
        this.xo && (this.xo.close(), this.dispatchEvent(new n("close", {
            reason: "user"
        })), this.xo = null)
    }, e.getUtils = function() {
        return c
...
function WebTCP(j, g) {
    ...
    this.sock.onmessage = function(g) {
        ...
        g.data.sID ? (sID = g.data.sID, c.sockets[sID].onEvent(g.data.eventName, g.data.data)) : g.data.cID &&
        (cID = g.data.cID, c.httpClients[cID].onEvent(g.data.eventName, g.data.data))
    };
    this.sock.onclose = function() {
        console.log("close")
    };
    this.createSocket = function(c, g, j) {
        return new Socket(this, c, g, j)
    };
